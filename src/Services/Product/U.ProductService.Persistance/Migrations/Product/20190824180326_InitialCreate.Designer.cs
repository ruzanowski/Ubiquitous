...
namespace U.ProductService.Persistance.Migrations.Product
{
    ...
    [Migration("20190824180326_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("U.ProductService.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("U.ProductService.Domain.Manufacturer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("U.ProductService.Domain.MimeType", b =>
                {
                    b.Property<int>("Id")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("U.ProductService.Domain.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("U.ProductService.Domain.Picture", b =>
                {
                    b.HasOne("U.ProductService.Domain.Manufacturer")
                        .WithMany("Pictures")
                        .HasForeignKey("ManufacturerId");

                    b.HasOne("U.ProductService.Domain.MimeType", "MimeType")
                        .WithMany()
            ...
            modelBuilder.Entity("U.ProductService.Domain.Product", b =>
                {
                    b.HasOne("U.ProductService.Domain.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("U.ProductService.Domain.ProductType", "ProductType")
                        .WithMany()
