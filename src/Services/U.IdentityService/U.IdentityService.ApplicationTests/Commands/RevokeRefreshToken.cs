...
namespace U.IdentityService.ApplicationTests.Commands
{
    ...
    {
        private (User fakeUser, RevokeRefreshTokenHandler sut, IUserRepository userRepository, IRefreshTokenRepository refreshTokenRepository) Arrange()
        {
            ...
            var sut = new RevokeRefreshTokenHandler(
        ...
        {
            //arrange
            var (fakeUser, sut, userRepository, refreshTokenRepository) = Arrange();
            ...
            refreshTokenRepository.GetAsync(Arg.Any<string>()).ReturnsForAnyArgs(fakeRefreshToken);
            var createAccessToken = new RevokeRefreshToken
            {
        ...
        [Fact]
        public async Task Should_Throw_IdentityException_On_Not_Existing_Token()
        {
            //arrange
