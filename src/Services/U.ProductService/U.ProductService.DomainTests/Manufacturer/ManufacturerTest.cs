...
namespace U.ProductService.DomainTests.Manufacturer
{
    public class ManufacturerTest
    {
        ...
        public void Should_AddPicture_AddedPictureAndRaisedPictureAddedDomainEvent()
        {
            ...
            //act
            manufacturer.AddPicture(pictureId,
                fileStorageId,
                filename,
                description,
                url,
            ...
            manufacturer.AggregateTypeName.Should().Be(nameof(Domain.Aggregates.Manufacturer.Manufacturer));
            ...
            picture.AggregateRootId.Should().Be(manufacturer.Id);
            picture.AggregateRootName.Should().Be(nameof(Domain.Aggregates.Manufacturer.Manufacturer));
        }
        ...
        public void Should_AddPictureWithNullArguments_ThrownDomainException(string filename, string description, string url)
        {
            ...
            //act
            Action action = () => manufacturer.AddPicture(pictureId,
                fileStorageId,
                filename,
                description,
                url,
        ...
        public void Should_TryDeletePictureNotExistingPicture_ThrownDomainException()
        {
            ...
            Action action = () => manufacturer.DeletePicture(Guid.Empty);
        ...
        public void Should_GetDraftManufacturer_DefinedManufacturer()
        {
            //arrange
            //act
            var manufacturer = Domain.Aggregates.Manufacturer.Manufacturer.GetDraftManufacturer();

            //assert
            manufacturer.Should().NotBeNull();
        }

        private Domain.Aggregates.Manufacturer.Manufacturer GetManufacturer()
        {
            return new Domain.Aggregates.Manufacturer.Manufacturer(_manufacturerId,
                _uniqueClientId,
                _name,
                _description);
        }
