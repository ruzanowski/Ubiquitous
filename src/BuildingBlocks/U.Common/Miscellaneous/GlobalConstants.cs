namespace U.Common.Miscellaneous
{
    ...
    {
        public const string SmartStoreExternalSourceName = "SMART_STORE";
        public const int SmartStoreSeededCategories = 10;
        public const int SmartStoreSeededManufacturers = 10;
